...
appBar: AppBar(
  ...
  centerTitle: true,
  title: Text('Welcome',style: TextStyle(color: Colors.white,fontSize: 22,fontWeight: FontWeight.bold),),
),
      drawer: Drawer(
        child: ListView(
          children: [
            DrawerHeader(child: Text('All in one',style: TextStyle(fontWeight: FontWeight.bold),)),
            UserAccountsDrawerHeader(decoration: BoxDecoration(color: Colors.blueAccent),
                accountName: Text('Umar'), accountEmail: Text('umarbisharat77@gmail.com')),
            ListTile(
      ...
      body: Column(
        children: [
          SizedBox(height: 22,),
          Center(child: Text('Log In',style: TextStyle(color: Colors.blue,fontWeight: FontWeight.bold,fontSize: 22),)),
          SizedBox(height: 22,),
          Padding(
  ...
  child: Text('forger password ?'),
          ...
          Container(
            ...
            child: TextButton(onPressed: (){
              ...
              child: Text("Let's Jump",style: TextStyle(fontSize: 22,fontWeight: FontWeight.bold,color: Colors.white),),
            ),
            ),
        ],
      ),
